...
import (
	...
	apiv1alpha1 "githum.com/Sayed-Imran/microservice-operator/api/v1alpha1"
)
...
//+kubebuilder:rbac:groups=api.sayedimran.com,resources=microservices,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=api.sayedimran.com,resources=microservices/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=api.sayedimran.com,resources=microservices/finalizers,verbs=update
